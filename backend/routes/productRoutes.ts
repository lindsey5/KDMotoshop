...
import { create_product, delete_product, get_inventory_status, get_product_by_id, get_products, get_published_product_by_id, get_top_products, total_products, update_product } from "../controllers/productController";
...
router.get('/total', adminRequireAuth, total_products);
