...
import { create_product, get_product_by_id, get_product_by_id_with_reserved, get_products, get_products_with_reserved, get_top_products, update_product } from "../controllers/productController";
