...
import { adminReadAllNotifications, get_admin_notifications, get_customer_notifications, update_admin_notification, update_customer_notifications } from "../controllers/notificationController";

const router = Router();

router.get('/admin', adminRequireAuth, get_admin_notifications);
router.put('/admin', adminRequireAuth, adminReadAllNotifications);
