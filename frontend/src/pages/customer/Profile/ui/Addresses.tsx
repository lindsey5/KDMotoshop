    ...
    return (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
            ...
            {addresses.map((address, index) => (
                <Card
                    key={index}
                    className="p-6 rounded-2xl border shadow-sm w-full"
                >
                <div className="flex flex-col lg:flex-row justify-between gap-6">
                    {/* Info Section */}
                    <div className="flex-1 flex flex-col lg:flex-row items-start gap-4 lg:gap-6">
                    <div
                    ...
                    <div className="w-full flex-1 flex flex-col gap-2">
                        ...
                        <div className="flex items-start gap-2">
                            <MapPin
                            size={16}
                            className={`mt-1 ${isDark ? "text-red-400" : "text-red-600"}`}
                            />
                            <div
                    ...
                    {/* Action Buttons */}
                    <div className="flex flex-row lg:flex-col items-start lg:items-end gap-3 mt-4 lg:mt-0">
                    <button
